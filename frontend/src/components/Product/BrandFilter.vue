...
import { ref } from 'vue'
import { ProductFilterBrands } from '@/enums/products/enums'
import useProductDropdowns from '@/composables/products/product-dropdowns'
import productFilters from '@/composables/products/product-filters'
...
<template>
    ...
    <div ref="productBrandElement">
        <button @click="toggleDropdown('brand')" id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
            ...
            <div class="grid gap-4 sm:grid-cols-1 sm:gap-6 items-center">
                <div>
                    ...
                    <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                        <li v-for="(brand, index) in ProductFilterBrands" :key="index" class="flex items-center">
                            <input @click="selectedFilters(brand, 'brand')" :id="brand + index" type="checkbox" :value="brand"
