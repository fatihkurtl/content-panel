...
const handleCheckboxChange = (event: Event, chart: any) => {
...
<div class="min-w-sm w-full min-h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
  
  <div class="flex justify-between mb-3">
      <div class="flex justify-center items-center">
          <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Web site trafiği</h5>
  ...
  <div>
    <div class="flex" id="devices">
      <div class="flex items-center me-4">
          ...
          <label for="desktop" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Masaüstü</label>
      </div>
      <div class="flex items-center me-4">
      ...
      <div class="flex items-center me-4">
          ...
          <label for="mobile" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mobil</label>
      </div>
    </div>
  </div>

  <!-- Donut Chart -->
  <div class="py-6 min-w-full" id="donut-chart"></div>
